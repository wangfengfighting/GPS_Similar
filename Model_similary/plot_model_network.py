...
data = np.loadtxt('result.txt',dtype=str,delimiter=',',usecols=(0,1,2))
...
#nx.draw_networkx_nodes(G,pos,with_labels=True,node_size=1200,node_color=colors,label='ll')
nx.draw(G,pos,with_labels=True, node_size=1200,node_color=colors,label='ll')
